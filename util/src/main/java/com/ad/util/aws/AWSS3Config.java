...
public class AWSS3Config {
  ...
  public AmazonS3 amazonS3Client(final AWSCredentialsProvider credentials) throws S3UploadException {
    try {
  ...
  private AWSS3ConnectionProperties getAWSProperties() throws Exception {
    final AWSS3ConnectionProperties conf = mapper.readValue(PropertiesUtil.getProperty("aws.conf.json"), AWSS3ConnectionProperties.class);
    if (null == conf)
