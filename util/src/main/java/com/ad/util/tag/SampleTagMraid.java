...
public class SampleTagMraid {
  ...
  public static String getSampleMraid() {
    ...
    String s = "<script src=\"mraid.js\"></script> \n"
        ...
        + "\t// image loaded pixel \n"
        + "\t eventTrack(\"http://ec2-18-191-183-129.us-east-2.compute.amazonaws.com:8080/trk?guid={TAG_GUID}&sessionId={SESSION_ID}&eventId=1\");\n"
        + "    if (!mraid.isViewable()) {\n"
        ...
        + "\t\teventTrack(\"http://ec2-18-191-183-129.us-east-2.compute.amazonaws.com:8080/trk?guid={TAG_GUID}&sessionId={SESSION_ID}&eventId=2\");\n"
        + "\t}\n"
        + "\tattachEventListener(\"click\", img , function (e) {\n"
        + "\t\te.preventDefault();\n"
        + "\t\tmraid.open('http://ec2-18-191-183-129.us-east-2.compute.amazonaws.com:8080/clk?guid={TAG_GUID}&sessionId={SESSION_ID}');\n"
        + "\t\treturn false;\n"
        + "\t});\n"
        + "\tattachEventListener(\"error\", img , function (e) {\n"
        + "\t\te.preventDefault();\n"
        + "\t\teventTrack(\"http://ec2-18-191-183-129.us-east-2.compute.amazonaws.com:8080/trk?guid={TAG_GUID}&sessionId={SESSION_ID}&eventId=11\");\n"
        + "\t\treturn false;\n"
        + "\t});\n"
        + "}\n"
        + "\n"
