...
import com.ad.server.handlers.TrackHandler;
...
public class AdServerVertx extends AbstractVerticle {
  ...
  public void start() {
    ...
    router.get("/trk").handler(this::handleTrackRequest);
  ...
  private void handleTrackRequest(final RoutingContext routingContext) {

    RequestHandler handler = new TrackHandler(routingContext);
    handler.handleRequest();
